package com.pine.core.util.encrypt;


import com.pine.core.util.PineConst;
import com.pine.core.util.PineUtils;
...
/**
 * Created by chenbupang on 2017-11-23 17:04
 */
public class EncryptUtil {
    ...
    public static byte[] md5FileToByte(File file) {
        if (file == null) {
            ...
            try {
                ...
                PineUtils.closeQuietly(fis);
                PineUtils.closeQuietly(digestInputStream);
            }
    ...
    public static void main(String[] args) {
        ...
        System.out.print(EncryptUtil.md5("admin", "admin"));
        System.out.print(PineConst.CLASSPATH);
